            ...
            <div class="flex items-center justify-center">
              <div class="flex text-xl text-gray-600 p-12 gap-4 flex-col">
                ...
                >
                  ...
                  <input type="text" name="passKey" id="passKey" class="border-2 border-gray-400 rounded px-4 py-1" placeholder="" required autocomplete="off" ></input>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-center">
              <div class="flex text-xl text-gray-600 p-12 gap-4 flex-col">
                ...
                >
                  ...
                  <input type="text" name="name" id="name" class="border-2 border-gray-400 rounded px-4 py-1" placeholder="" autocomplete="off"></input>
                </label>
              </div>
            </div>
            <input type="hidden" name="fileDirectory" id="fileDirectory" required></input>
